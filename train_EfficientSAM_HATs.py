...
def get_arguments():
    ...
    parser.add_argument(
        "--snapshot_dir",
        type=str,
        default="snapshots_2D/EfficientSAM_dynamichead_logits_HATs/",
    )
    parser.add_argument(
        "--reload_path",
        type=str,
        default="snapshots_2D/EfficientSAM_dynamichead_logits_0201_15class/MOTS_DynConv_EfficientSAM_dynamichead_logits_0201_15class_e50.pth",
    )
...
def HATs_learning(
    ...
    for ii in range(len(HATs_matrix[1])):
        ...
        if now_relative == 1:
            ...
            semi_labels = labels
            semi_preds = (
                semi_labels.unsqueeze(1).repeat(1, 2, 1, 1) * semi_preds
...
def main():
    ...
    with Engine(custom_parser=parser) as engine:
        ...
        HATs_matrix[
            ...
            -1
        )  # 1_cortex  cap is covered by cortex but don't know between in/middle/out
        ...
        HATs_matrix[
            ...
            -1
        )  # 1_cortex  tuft is covered by cortex but don't know between in/middle/out
        ...
        HATs_matrix[
            ...
            -1
        )  # 1_cortex  PTC is covered by cortex but don't know between in/middle/out
        ...
        HATs_matrix[
            ...
            -1
        )  # 1_cortex  pod is covered by cortex but don't know between in/middle/out
        ...
        for epoch in range(50, args.num_epochs):
            ...
            if args.local_rank == 0:
                print(
                    "Epoch_sum {}: lr = {:.4}, loss_Sum = {:.4}".format(
                        epoch, optimizer.param_groups[0]["lr"], epoch_loss.item()
                    )
                )
                writer.add_scalar(
                ...
                plt.legend()
                plt.savefig(
                    "TrainingLoss_HATs_omni-seg_15classes_pretrained_cls_sls_%s.png"
                    % (os.path.basename(args.snapshot_dir))
                )
                plt.clf()
                ...
                df_loss.to_csv(
                    "TrainingLoss_HATs_omni-seg_15classes_pretrained_cls_sls.csv"
                )

            if (
                (epoch >= 0)
                and (args.local_rank == 0)
                and (((epoch % 10 == 0) and (epoch >= 800)) or (epoch % 1 == 0))
            ):
                ...
                with torch.no_grad():
                    for iter, batch1 in enumerate(valloader):
                        ...
                        output_folder = os.path.join(
                            args.snapshot_dir.replace(
                                "snapshots_2D/", "/Data4/HATs/validation_"
                            ),
                            str(epoch),
                        )
                        ...
                        if task0_pool_image.num_imgs >= batch_size:
                            ...
                            for pi in range(len(images)):
                                ...
                                plt.imsave(
                                    os.path.join(
                                        output_folder, str(num) + "_image.png"
                                    ),
                                    img,
                                )
                                plt.imsave(
                                    os.path.join(output_folder, str(num) + "_mask.png"),
                                    labels[pi, ...].detach().cpu().numpy(),
                                )
                                plt.imsave(
                                    os.path.join(
                                        output_folder,
                                        str(num) + "_preds_%s.png" % (now_task.item()),
                                    ),
                    ...
                    if task0_pool_image.num_imgs > 0:
                        ...
                        for pi in range(len(images)):
                            ...
                            plt.imsave(
                                os.path.join(output_folder, str(num) + "_image.png"),
                                img,
                            )
                            plt.imsave(
                                os.path.join(output_folder, str(num) + "_mask.png"),
                    ...
                    print(
                        ...
                        " \n 14smooth_f1={:.4} dsc={:.4} tpr={:.4} ppv={:.4}\n".format(
                            ...
                            avg_val_PPV[9].item(),
                            avg_val_F1[10].item(),
                            avg_val_Dice[10].item(),
                            avg_val_TPR[10].item(),
                            avg_val_PPV[10].item(),
                            avg_val_F1[11].item(),
                            avg_val_Dice[11].item(),
                            avg_val_TPR[11].item(),
                            avg_val_PPV[11].item(),
                            avg_val_F1[12].item(),
                            avg_val_Dice[12].item(),
                            avg_val_TPR[12].item(),
                            avg_val_PPV[12].item(),
                            avg_val_F1[13].item(),
                            avg_val_Dice[13].item(),
                            avg_val_TPR[13].item(),
                            avg_val_PPV[13].item(),
                            avg_val_F1[14].item(),
                            avg_val_Dice[14].item(),
                            avg_val_TPR[14].item(),
                            avg_val_PPV[14].item(),
                        )
                    )
